...
image are v0.3.13 and are built against CLIProxyAPI v7.2.146. The published
v0.3.13 GitHub Release archives are checksummed and pinned by size. The CPA image remains an
