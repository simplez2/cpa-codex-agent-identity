...
本文按当前源码说明插件、sidecar、CPA auth 文件、批量导入、代理热加载和 reset-credit 的真实运行路径。当前源码开发线为 v0.3.13；已发布 registry、可直接安装资产和 sidecar 镜像仍为 v0.3.12，v0.3.12 Release 资产的大小、SHA-256、归档根目录和目标架构均已校验。
Release baseline: CLIProxyAPI v7.2.146；v0.3.13 的 registry 更新必须等待新资产真实生成、发布并完成校验。
